...
@receiver(post_delete, sender=Favourites, dispatch_uid='post_deleted')
def object_post_delete_handler(sender, **kwargs):
    cache.delete('favourites_objects')


@receiver(post_save, sender=Favourites, dispatch_uid='posts_updated')
